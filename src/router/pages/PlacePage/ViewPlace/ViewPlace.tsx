...
const ViewPlace: React.FC<ViewPlacePropsType> = ({ info }) => {
  return (
    <div
      ...
      style={{
        backgroundImage: `linear-gradient(to right, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("../public/assets/images${info?.properties.photo_link}")`,
      }}
    >
      <div
        className={style.view__container}
        style={{
          backgroundImage: `url("../public/assets/images${info?.properties.photo_link}")`,
        }}
      >
